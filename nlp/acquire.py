...
def check_subs():
    import wrangle_codeup_blog
    print('wrangle_codeup_blog.py success!')
    import wrangle_news_articles
    print('wrangle_news_articles.py success!')
